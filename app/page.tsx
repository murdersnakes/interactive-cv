    ...
    <div className='min-h-screen grid'>
      <div className='place-self-center'>
        ...
        <div className='grid lg:grid-cols-3 gap-5 mt-5'>
          <Link
            href='/about'
            className='flex items-center gap-2 rounded hover:bg-rose-500 hover:text-black p-3 trans hover:shadow-lg'
          >
          ...
          <Link
            href='/skills'
            className='flex items-center gap-2 rounded hover:bg-amber-500 hover:text-black p-3 trans hover:shadow-lg'
          >
            <TbInfoCircleFilled size={36} />
            <div>
          ...
          <Link
            href='/experience'
            className='flex items-center gap-2 rounded hover:bg-emerald-500 hover:text-black p-3 trans hover:shadow-lg'
          >
            <TbInfoCircleFilled size={36} />
            <div>
